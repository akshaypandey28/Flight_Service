...
- User should be able to select the class of the fights [Non mandatory]
...
- Users should be able to review the flight journey if and only if thye have booked a flight
...
- User should able able to authenticate to our system using email and password
